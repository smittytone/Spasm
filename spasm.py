...
def parse_line(line, line_number):
    ...
    while True:
        ...
        a_char = line[char_ptr]

        # Is the character a space?
        if a_char == " " and in_comment is False and in_quote is False:
            # Only chop the line if we're not within a string or a comment
            if found_word: line_parts.append(found_word)
            found_word = ""
            char_ptr += 1
            continue
        ...
        if a_char == '"':
            if in_quote is False:
                ...
                line_parts.append(found_word)
                found_word = ""
        if a_char in (";", "*") and in_comment is False:
    ...
    while len(line_parts) < 4:
        # Add empty tailing columns
        line_parts.append(" ")
